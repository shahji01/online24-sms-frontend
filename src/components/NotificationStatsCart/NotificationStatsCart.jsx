...
const NotificationStatsCart = ({
    ...
    return (
        <div
            className={`${styles.notification_wrapper} rounded-3 border-0 w-100 h-100`}
        >
            <div className={`${styles.header} bg-dark border-0 rounded-top-3`}>
            ...
            <div className={`${styles.notifications} p-0 rounded-bottom-3`}>
                <ul>
